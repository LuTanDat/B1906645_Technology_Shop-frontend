<template>
    ...
    >
        <div class="form-group col-md-4">
            <label class="control-label" for="code">ID Khách hàng</label>
            <Field
                name="code"
                type="text"
                class="form-control"
                v-model="customerLocal.code"
            />
        ...
        <div class="form-group col-md-4">
            ...
            <!-- <h2 class="mt-2">{{typeof(customerLocal.email)}}</h2> -->
        ...
        <div class="form-group col-md-4">
            ...
            <!-- <h2 class="mt-2">{{typeof(customerLocal.dateOfBirth)}}</h2> -->
        </div>
        <div class="form-group col-md-4">
            <label class="control-label" for="sex">Giới tính</label>
            <select name="sex" id="sex" class="form-control" required v-model="customerLocal.sex">
        ...
        <!-- <div class="form-group col-md-4">
            ...
            <select name="position" id="position" class="form-control" required v-model="customerLocal.position">
        ...
        <div class="form-group" style="display: flex;">
            ...
            <router-link :to="{name: 'customer.management'}">
                <button class="btn m-2 btn-cancel">Hủy bỏ</button>
            </router-link>
            
            <!-- <button
                v-if="customerLocal.id"
                type="button"
                class="ml-2 btn m-3 btn-danger"
                @click="$emit('delete:customer', customerLocal.id)"
            >
                Xóa
            </button> -->
        </div>
